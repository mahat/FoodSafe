...
window.App = {
  ...
  createContract: function() {
    console.log("foodsafe contract " + foodSafeContract);
  ...
  AddNewLocation: function() {
    ...
    deployedFoodSafe.AddNewLocation(locationId,locationName,encryptedSecret,function(error ,returnVal){
      console.log(error);
  ...
  getCurrentLocation : function() {
    ...
    deployedFoodSafe.GetTrailCount.call(function(error, trailCount){
      deployedFoodSafe.GetLocation.call(trailCount - 1, function (error, returnVal) {
        document.getElementById("locationId").value = returnVal[0];
        document.getElementById("locationName").value = returnVal[1];
        var encryptedSecret = returnVal[4];
